          ...
          <div class="text-white">
            <div class="mt-4">
              ...
              <div v-for="(task,index) in sendTaskData" class="border-2 modal-content rounded"  style="margin-bottom:10px">
                ...
                <!-- 업무 반복 구현 끝-->
              <div v-if="overtime" class="ml-5 mt-10 pt-5 flex border-t-2" style="width: 945px;">
                <div>
                  <div  class="" style="width: 100px">
                    <p>초과 근로 사유</p>
                  </div>
                  <div class="mt-1 text-black" style="width: 400px">
                    <input v-model="overtimeDetail" type="text" style="width: 400px" class="rounded">
                  </div>
  ...
  methods:{
    ...
    SetData(){
      ...
      for(var i = 0;i<this.oneDayInfo.length;i++){
        ...
        this.sendTaskData.push({
          ...
          perf_day: this.oneDayInfo[i].perf_day,
          ...
          sign_status: this.oneDayInfo[i].sign_status,
    ...
    addTaskBox(){
      ...
      this.sendTaskData.push({
        ...
        task_hour: 0,
        perf_day: this.oneDayInfo[0].perf_day,
        day_hour: 0,
    ...
    PostData(status){
      ...
      for(var i = 0;i<this.sendTaskData.length;i++){
        ...
        this.sendTaskData[i].sign_status = status;
